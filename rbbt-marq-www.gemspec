...
Gem::Specification.new do |s|
  ...
  s.homepage = %q{http://github.com/mikisvaz/rbbt-marq-www}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.5}
  s.summary = %q{MARQ online interface (SOAP, merb)}
  s.test_files = [
    "test/test_rbbt-marq-www.rb",
     "test/helper.rb"
  ]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ruby-yui>, [">= 0"])
